...
Design goals:
    * using honest client modules for produce_update /  _local_train_wm
...
Attacker A -- ReducedDataFreeRider ("+N"):
    ...
    - 0 being trigger class images only and -1 being full data shard (honest client)

TODO: test Attacker B -- OracleTapFreeRider (oracle version of the submarine):
